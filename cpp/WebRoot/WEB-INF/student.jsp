...
<div class="col-md-10">
<ul class="pager">
  <li><a href="${pageContext.request.contextPath }/admin_student.action?studentid=${student.id-1}">Previous</a></li>
  <li><a href="${pageContext.request.contextPath }/admin_student.action?studentid=${student.id+1}">Next</a></li>
</ul>
</div>
<div class="col-md-2">
